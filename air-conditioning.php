	...
	<section class="pager-sec">
		<div class="container">
			<ul class="pager-info">
                ...
                <li><a title="">Air Conditioning</a></li>
							...
							<div class="service-single-details">
								...
								<div class="service-svv">
									...
									<div class="svv-info">
										...
										<p>Omzfield has been repairing AC systems for more than 10 years. We want you to be cool and comfortable, and we’ll guarantee any repairs we make through a one-year warranty.</p>
									</div><!--svv-info end-->
								</div><!--service-svv end-->
							</div>
						</div>
								...
								<div class="contact_wd">
									...
									<ul>
										<li>
											...
											<h4>No 25 Lobito Crescent Wuse II Abuja</h4>
										</li>
										<li>
										...
										<li>
											...
											<h4>24/7 Emergency Service: +234 803 449 6428</h4>
										</li>
									</ul>
								</div><!--contact_wd end-->
								<div class="ht_form">

...
<body class="home layout2">
							...
							<li>
								<div class="head-info">
									<span class="hd_is map">
										<svg version="1.1" id="Capa_1395" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							...
							<li>
								<div class="head-info">
									<span class="hd_is time">
										<svg version="1.1" id="Capa_1349" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<ul class="hd_opts">
				<li class="active">
					<a href="#" title="" class="apt_form_btn"><span>Appointment</span>
						<span class="apt-icon">
							<svg version="1.1" id="Capa_1344" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				...
				<li>
					<a href="#" title="" class="direction_map_btn"><span>Get Directions</span>
						<span class="apt-icon">
							<svg version="1.1" id="Capa_338" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="22px" viewBox="0 0 97.713 97.713" xml:space="preserve">
								<g>
									<path d="M48.855,0C29.021,0,12.883,16.138,12.883,35.974c0,5.174,1.059,10.114,3.146,14.684
										c8.994,19.681,26.238,40.46,31.31,46.359c0.38,0.441,0.934,0.695,1.517,0.695s1.137-0.254,1.517-0.695
										c5.07-5.898,22.314-26.676,31.311-46.359c2.088-4.57,3.146-9.51,3.146-14.684C84.828,16.138,68.69,0,48.855,0z M48.855,54.659
			...
			<div class="container">
				...
				<div class="apt_btn">
					<a href="#" title="" class="appointment_btn apt_form_btn"> Appointment
						<span class="apt-icon">
							<svg version="1.1" id="Capa_134923" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="488.152px" height="488.152px" viewBox="0 0 488.152 488.152" xml:space="preserve">
							<g>
								<g>
									<path d="M177.854,269.311c0-6.115-4.96-11.069-11.08-11.069h-38.665c-6.113,0-11.074,4.954-11.074,11.069v38.66
			...
			<div class="container">
				...
				<div class="apt_btn">
					<a href="#" title="" class="appointment_btn apt_form_btn">
						<span class="apt-icon">
							<svg version="1.1" id="Capa_139499" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="488.152px" height="488.152px" viewBox="0 0 488.152 488.152" xml:space="preserve">
							<g>
								<g>
									<path d="M177.854,269.311c0-6.115-4.96-11.069-11.08-11.069h-38.665c-6.113,0-11.074,4.954-11.074,11.069v38.66
										c0,6.123,4.961,11.079,11.074,11.079h38.665c6.12,0,11.08-4.956,11.08-11.079V269.311L177.854,269.311z"></path>
				...
				<div class="search_icon">
					<svg version="1.1" id="Capa_499" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<div class="container">
				<nav>
					<ul>
						...
						<li><a class="active" href="gallery_page.html" title="">Gallery</a></li>
	...
	<div class="page-content p-0">
		...
		<section class="block gallery_sec">
			<div class="container">
				<div class="sec-title">
					<h4>Check out our work!</h4>
					<h2>Our Photo Gallery</h2>
					<p>At Heating & Cooling, we take a lot of pride in the work that we complete for our clients. Below we have included photos from some of our most recent commercial and residential HVAC projects.</p>
				</div><!--sec-title end-->
			</div>
			<div class="gallery-sec">
				<ul class="tabs_list">
					<li class="active" data-tab="cooling-gallery-tab">
						<span class="tc_icon">
					...
					<li data-tab="heating-gallery-tab" class="heating">
				...
				<div class="gallery-content">
					<div class="gallery-tab active" id="cooling-gallery-tab">
						<div class="gallery-info">
							<img src="images/resources/gallery1.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery2.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery3.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery4.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery5.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery6.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery7.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery8.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery9.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery10.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery11.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery12.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery13.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery14.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">
							<img src="images/resources/gallery15.jpg" alt="">
						</div><!--gallery-info end-->
					</div><!--gallery-tab end-->
					<div class="gallery-tab" id="heating-gallery-tab">
						<div class="gallery-info">
							<img src="images/resources/gallery1.jpg" alt="">
						</div><!--gallery-info end-->
						<div class="gallery-info">

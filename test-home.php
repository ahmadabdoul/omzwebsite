...
<!--srvs_dv end-->
	...
	<section class="block block less-gap rem_pb_0">
		...
		<img src="images/resources/bg3_3.jpg" alt="" class="btm_bg">
	</section>
					...
					<div class="col-lg-4">
						<div class="blog-post">
							...
							<div class="blog-info">
								...
								<h2 class="post-title"><a href="blog_single_post_page.html" title="">The Emergency Heat Switch on Heat Pumps — What is It and How Does It Work</a></h2>
								<a href="blog_single_post_page.html" title=""><i class="fa fa-play"></i>Continue Reading</a>
							</div><!--blog-info end-->
						</div><!--blog-post end-->
					</div>
					<div class="col-lg-4">
						<div class="blog-post">
							...
							<div class="blog-info">
								...
								<h2 class="post-title"><a href="blog_single_post_page.html" title="">It’s Never Too Late for Furnace Installation</a></h2>
								<a href="blog_single_post_page.html" title=""><i class="fa fa-play"></i>Continue Reading</a>
							</div><!--blog-info end-->
						</div><!--blog-post end-->
					</div>
					<div class="col-lg-4">
						<div class="blog-post">
							...
							<div class="blog-info">
								...
								<h2 class="post-title"><a href="blog_single_post_page.html" title="">Next-generation Heat Pump Offers More Affordable Heating and Cooling </a></h2>
								<a href="blog_single_post_page.html" title=""><i class="fa fa-play"></i>Continue Reading</a>
							</div><!--blog-info end-->
						</div><!--blog-post end-->
					</div>
	...
	<section class="block sap-sec air_sec">
		...
		<div class="container">
			<div class="sep-text">
				...
				<a href="#" title="" class="lnk_default apt_form_btn">Make an Appointment</a>
			</div><!--sep-text end-->
		</div>
	</section><!--sap-sec end-->
		...
		<div class="container">
			...
			<div class="maintaince_sec">
				<ul class="svss_list">
					...
					<li data-tab="proj-plan">Protection Plans</li>
					<li data-tab="rq-form">Request Form</li>
				...
				<div class="tab_content active" id="coupan_full">
					<ul class="tbs-list">
						<li class="active" data-tab="cooling_services">
							<span class="vx-icon">
								<svg version="1.1" id="Capa_17239" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
									 viewBox="0 0 333.316 333.316" xml:space="preserve">
								<path d="M315.797,224.574l-5.557-20.818l-39.684,10.592l-33.572-19.441l41.764-18.377v-19.75l-41.767-18.377l33.572-19.439
									l39.689,10.59l5.557-20.818l-18.861-5.025l19.361-11.197l-10.82-18.645l-19.324,11.188l5.029-18.855l-20.818-5.551l-10.588,39.674
									l-33.473,19.338l4.918-45.148l-17.061-9.877l-36.758,26.892V52.824l29.045-29.018L191.221,8.539l-13.816,13.807V0h-21.531v22.346
							...
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										...
										<h2>Any Repair</h2>
										<p>Must present coupon at time of repair, cannot be combined with any other offer.</p>
										<div class="validity">
											<h5>Valid Through 12/31/2020</h5>
											<span class="zz_icon">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										<h3>FREE</h3>
										<h2>Furnace Repair Service Call</h2>
										<p>Minimum $149 paid repair required.</p>
										<div class="validity">
											<h5>Valid Through 12/31/2020</h5>
											<span class="zz_icon">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										<h3><small>$</small>499 OFF</h3>
										<h2>New HVAC System Installation</h2>
										<p>Qualifying systems only. Call for details.</p>
										<div class="validity">
											<h5>Valid Through 12/31/2020</h5>
											<span class="zz_icon">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										<h3><small>$</small>99.00</h3>
										<h2>Maintenance Agreement</h2>
										<p>New customers, for the first 12 month.</p>
										<div class="validity">
											<h5>Valid Through 12/31/2020</h5>
											<span class="zz_icon">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										<h3><small>$</small>20.00</h3>
										<h2>Water Heater Inspection</h2>
										<p>One tune-up per properly functioning unit. </p>
										<div class="validity">
											<h5>Valid Through 12/31/2020</h5>
											<span class="zz_icon">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										<h3><small>$</small>45 OFF</h3>
										<h2>Tune Up Special</h2>
										<p>23-Point Preventative Maintenance & Safety Inspection</p>
										<div class="validity">
											<h5>Valid Through 12/31/2020</h5>
											<span class="zz_icon">
										...
										<span class="bfr-shape">
											<svg version="1.1" id="Capa_30" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												 viewBox="0 0 512 512" xml:space="preserve">
											<g>
												<g>
													<path d="M512,107.275c-23.658-33.787-70.696-42.691-104.489-19.033L233.753,209.907l-63.183-44.246
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										...
										<span class="bfr-shape">
											<svg version="1.1" id="Capa_34934" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												 viewBox="0 0 512 512" xml:space="preserve">
											<g>
												<g>
													<path d="M512,107.275c-23.658-33.787-70.696-42.691-104.489-19.033L233.753,209.907l-63.183-44.246
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										...
										<div class="validity">
											<h5>Valid Through 12/31/2020</h5>
											<span class="zz_icon">
												<svg version="1.1" id="Capa_37" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
													 width="475.078px" height="475.077px" viewBox="0 0 475.078 475.077" xml:space="preserve">
												<g>
													<path d="M458.959,217.124c-10.759-10.758-23.654-16.134-38.69-16.134h-18.268v-73.089c0-7.611-1.91-15.99-5.719-25.122
														c-3.806-9.136-8.371-16.368-13.699-21.698L339.18,37.683c-5.328-5.325-12.56-9.895-21.692-13.704
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										...
										<span class="bfr-shape">
											<svg version="1.1" id="Capa_4590" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												 viewBox="0 0 512 512" xml:space="preserve">
											<g>
												<g>
													<path d="M512,107.275c-23.658-33.787-70.696-42.691-104.489-19.033L233.753,209.907l-63.183-44.246
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="tb-info">
										...
										<span class="bfr-shape">
											<svg version="1.1" id="Capa_42" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												 viewBox="0 0 512 512" xml:space="preserve">
											<g>
												<g>
													<path d="M512,107.275c-23.658-33.787-70.696-42.691-104.489-19.033L233.753,209.907l-63.183-44.246
				...
				<div class="tab_content" id="rq-form">
					<div class="request_form">
						<p>Hours of business hours away! Remember, our technicians are professionally trained in customer service AND technical service. Our Technicians drive up to 95% of the time.</p>
						<form class="rqs_form" id="requestform" name="requestform" method="post" novalidate>
							<div id="success2">
								<p>Your message was sent successfully!</p>
							</div>
							<div id="error2">
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-sm-6">
									<div class="input_field datetimepicker-wrap">
										<input type="text" name="date" placeholder="Requested date of service?" class="datetimepicker">
										<svg version="1.1" id="Capa_19023" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
											 viewBox="0 0 512 512" xml:space="preserve">
										<g>
											<g>
								...
								<div class="col-lg-6 col-md-6 col-sm-6">
									<div class="input_field datetimepicker-wrap">
										...
										<svg version="1.1" id="Capa_1897" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
								...
								<div class="col-lg-12">
									<div class="input_field">
										<textarea name="comment" placeholder="Comment or Questions"></textarea>
									</div><!--input_field end-->
								</div>
								<div class="col-lg-12">
									<div class="submit_btn">
						...
						<div class="financ_tab_content">
							<div class="row">
								<div class="col-lg-6 fin-img-col">
									<div class="finan_img">
										<img src="images/resources/finan-img.jpg" alt="">
									</div><!--finan_img end-->
								</div>
								<div class="col-lg-6 fin-text-col">
									<div class="finan_text">
										<p>Heating & Cooling Service credit card is an easy and convenient way pay for your Heating & Cooling Service purchases.</p>
										<h3>Reasons To Finance</h3>
										<ul class="wegts-links">
											<li>Convenient application process with swift responses</li>
											<li>Experience the ease of making future add-on purchases with a revolving line of credit for purchases made exclusively at our store</li>
											<li>No prepayment penalties!*</li>
										</ul><!--wegts-links  end-->
										<ul class="wegts-links">
											<li>Buy now and pay over time.</li>
											<li>Enjoy the comfort of working with a sound financial service company with over 150 years of experience in the industry.</li>
											<li>Several options for submitting payments: Online, mail, and Speed Pay.</li>
										</ul><!--wegts-links  end-->
										<p class="m-0">* Heating & Cooling Service credit card issued with approved credit by Bank. For newly opened accounts, the APR for Purchases is 28.99%. </p>
									</div><!--finan_text end-->
								</div>
							</div>
					...
					<div class="testimonial">
						...
						<div class="testi_carousel">
							<div class="testi_slide">
								<p>All work was explained and we were shown where and what was to be done. Price was very fair. Workers were on time and ready to work. Job finished on time. Everything was cleaned and vacuumed. System worked properly. It was very nice to work with a company that had very polite and helpful employees at the job and in the office.</p>
								<h4><strong>– Wilson Trayer,</strong> customer</h4>
							</div><!--testi_slide end-->
							<div class="testi_slide">
								<p>All work was explained and we were shown where and what was to be done. Price was very fair. Workers were on time and ready to work. Job finished on time. Everything was cleaned and vacuumed. System worked properly. It was very nice to work with a company that had very polite and helpful employees at the job and in the office.</p>
								<h4><strong>– Wilson Trayer,</strong> customer</h4>
	...
	<section class="block partners-sec">
		<div class="container">
			<div class="sec-title">
				<h4>Quality brands we trust</h4>
				<h2>Our Partners</h2>
			</div><!--sec-title end-->
			<div class="pt_carousel">
				<div class="pt-logo">
					<img src="images/resources/pt-logo1.png" alt="">
				</div><!--pt-logo end-->
				<div class="pt-logo">
					<img src="images/resources/pt-logo2.png" alt="">
				</div><!--pt-logo end-->
				<div class="pt-logo">
					<img src="images/resources/pt-logo3.png" alt="">
				</div><!--pt-logo end-->
				<div class="pt-logo">
					<img src="images/resources/pt-logo4.png" alt="">
				</div><!--pt-logo end-->
				<div class="pt-logo">
					<img src="images/resources/pt-logo5.png" alt="">
				</div><!--pt-logo end-->
				<div class="pt-logo">
					<img src="images/resources/pt-logo6.png" alt="">
				</div><!--pt-logo end-->
				<div class="pt-logo">
					<img src="images/resources/pt-logo7.png" alt="">
				</div><!--pt-logo end-->
				<div class="pt-logo">
					<img src="images/resources/pt-logo8.png" alt="">
				</div><!--pt-logo end-->
				<div class="pt-logo">
					<img src="images/resources/pt-logo2.png" alt="">
				</div><!--pt-logo end-->
				...
				<div class="row">
					<div class="col-lg-3 col-md-4 col-sm-12">
						<div class="widget widget-about">
							<img src="images/ft-logo.png" width="150" height="150" alt="">
